...
export default class LanguageService implements ILanguageService {
  ...
  public async tokenize(utterances: string[], lang: string): Promise<string[][]> {
  ...
  public async vectorize(tokens: string[], lang: string): Promise<number[][]> {
