...
export const isOOS = <T extends sdk.ProblemType>(label: sdk.Label<T> | sdk.Elected<T>): boolean => {
...
export const makeKey = <T extends sdk.ProblemType>(label: sdk.Label<T>): string => {
  if (typeof label === 'string') {
    return label
  }
