...
const nativeExBaseFolder =
  ...
  (process.pkg
    ...
    : syspath.resolve(process.PROJECT_LOCATION, '../../../native-extensions'))
...
const nativeExtensions = ['node_sqlite3.node', 'fse.node', 'crfsuite.node', 'node-svm.node', 'sentencepiece.node']
